...
const Hero = () => {
  return (
    <header className='bg- [#CCCACB] bg-gradient-to-r from-[#CCCACB] via-[#c5a9a9] to-[#d6cdcd] relative overflow-hidden'>
        ...
        <Header/>
          <div className=" flex flex-col  items-center pb-20 pt-32" id='home' data-aos="fade-up">
            <h1 className='text-[#0D0D0D]  font-bold  sm:text-[64px] text-[48px] text-center max-w-[900px]'>Empowering Healthcare Solutions for Your Needs</h1>
